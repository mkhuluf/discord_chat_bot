...
# # the decouple module helps us access environment variables
# i.e., our API keys
...
API_URL = 'https://api-inference.huggingface.co/models/rmicheal48/'
...
def main():
    ...
    client = MyClient('DialoGPT-small-steven_universe')
    keep_alive()
